    ...
    <div class="panel panel-bordered argue-tree" data-tree-id="{{$tree->id}}" data-tree-locked="{{$tree->locked}}">
    	<div class="panel-heading">
    		...
    		<ul class="panel-actions argue-tree-actions">
            	<li class="argue-tree-action"><a class="argue-tree-action-show btn btn-icon btn-outline btn-success tooltip-success" data-toggle="tooltip" data-placement="top" href="{{route('tree.show', ['id'=>$tree->id])}}" title="Open Tree"><i class="fa fa-eye" aria-hidden="true"></i></a></li>
                @can ('edit', $tree)

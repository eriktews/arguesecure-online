...
<div class="form-group form-material">
  	...
  	{!! Form::select('tags[]', \App\Tag::all()->pluck('title','slug')->toArray(), $risk->tags->pluck('slug')->toArray(), ['class'=>'form-control', 'id'=>"risk-tags", 'data-plugin'=>'select2', 'data-select2-tags'=>'true', 'multiple']) !!}
</div>
